...
The initial versions, dependency order and Qt 5 choice were informed by
[nou/astro-soft-build](https://gitea.nouspiro.space/nou/astro-soft-build), whose
scripts are available under the following 0BSD notice:

> Copyright (C) 2022 by Dušan Poizl
>
...
Each built upstream project retains its own license. The builder copies its
